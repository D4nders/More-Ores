...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.LUMEN_HELMET);
        trimmedArmorItem(ModItems.LUMEN_CHESTPLATE);
        trimmedArmorItem(ModItems.LUMEN_LEGGINGS);
        trimmedArmorItem(ModItems.LUMEN_BOOTS);
    }

    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = MoreOres.MODID; // Change this to your mod id
