...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> LUMEN_ARMOR_MATERIAL = register("lumen",
            ...
            }), 16, 2f, 0.1f, () -> ModItems.LUMEN_INGOT.get());
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection, int enchantability, float toughness, float knockbackResistance, Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(MoreOres.MODID, name);
